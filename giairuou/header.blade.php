...
<header class="pr">
    ...
    <div class="fixCen head-info">
        <h1 class="rs"><a href="{{url('/')}}" class="logo" title="Cây giải rượu">
                <img src="{{url('viemgan/images/logo.png')}}" alt="Cây giải rượu" width="170" height="99" class="imgFull">
            </a></h1>
        <div class="slogan">
            <span>DƯỢC LIỆU GIẢM TÁC HẠI CỦA RƯỢU BIA</span>
            <span>GIẢI ĐỘC - PHÒNG XƠ GAN</span>
        </div>
