...
<header class="pr">
    ...
    <div class="fixCen head-info">
        <h1 class="rs"><a href="{{url('/')}}" class="logo" title="SÂM NHUNG CƯỜNG LỰC">
                <img src="{{url('viemgan/images/logo.png')}}" alt="SÂM NHUNG CƯỜNG LỰC" width="170" height="99" class="imgFull">
            </a></h1>
        <div class="slogan">
