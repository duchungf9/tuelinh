<div class="hotLine sp">
    ...
    <div class="header-mid">
        <div class="fix">
            ...
            <div class="phone">
                <img src="{{url('frontend/images/hotline.png')}}" alt="">
            </div>
            {{--<ul class="nav-social">--}}
...
<div class="btn-group-fix banner-ads">
    ...
    <a href="phanphoi.html" title="Điểm bán sản phẩm"><img src="http://www.giaidocgan.vn/frontend/images/location-icon.png" alt="Điểm bán sản phẩm" width="63" height="63"></a>
</div>